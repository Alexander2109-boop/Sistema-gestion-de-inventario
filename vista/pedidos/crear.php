        ...
        <div class="card">
            ...
            <form action="index.php?modulo=pedidos&accion=guardar" method="post">
                <div class="form-group">
                    <label for="cliente_input"><i class="bi bi-person"></i> Cliente <span class="required">*</span></label>
                    <input type="text" id="cliente_input" placeholder="Buscar cliente..." list="clientes_list" autocomplete="off" required>
